...
const animalsButton = document.getElementById('animals-button').addEventListener('click', ohMy) 
...
const repeatMyParam = () => {
    return axios.get(`http://localhost:3000/repeat/I-hate-coding`)
    .then(res => {
        return res.data
    })
}
...
axios.get('http://localhost:3000/repeat?myquery=a-really-awesome')
